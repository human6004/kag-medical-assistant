...
- Triển khai các chương trình tuyên truyền, nâng cao nhận thức của cán bộ, công chức, doanh nghiệp, người dân, thanh thiếu niên và học sinh về dữ liệu và ứng dụng TTNT; các giải pháp nâng cao nhận thức về TTNT để các ngành, các cấp, các tổ chức, đoàn thể, cá nhân hiểu rõ vai trò, lợi ích của TTNT, các kỹ năng cơ bản cần thiết phải chuẩn bị để đón nhận, phát triển các ứng dụng TTNT, trong đó quan tâm đến giải pháp nâng cao nhận thức về quản lý thay đổi.
